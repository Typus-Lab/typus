...
extend module typus::tails_staking {
    ...
    #[test, expected_failure(abort_code = EStakingInfoNotFound),allow(deprecated_usage)]
    ...
    #[test, expected_failure(abort_code = EInsufficientExp),allow(deprecated_usage)]
    ...
    #[test, expected_failure(abort_code = EInvalidFee),allow(deprecated_usage)]
    ...
    #[test, expected_failure(abort_code = EAlreadySignedUp),allow(deprecated_usage)]
    ...
    #[test, expected_failure(abort_code = EMaxStakeAmountReached),allow(deprecated_usage)]
    ...
    #[test, expected_failure(abort_code = EInvalidInput), allow(deprecated_usage)]
    ...
    #[test, expected_failure(abort_code = EInvalidToken),allow(deprecated_usage)]
