...
module typus::leaderboard {
    ...
    public fun activate_leaderboard(
        ...
        if (!dynamic_field::exists(&registry.active_leaderboard_registry, key)) {
            dynamic_field::add(
    ...
    public fun deactivate_leaderboard(
        ...
        if (!dynamic_field::exists(&registry.inactive_leaderboard_registry, key)) {
            dynamic_field::add(
    ...
    public fun score(
        ...
        if (!dynamic_field::exists(&registry.active_leaderboard_registry, key) || score == 0) {
            return vector[0]
        };
