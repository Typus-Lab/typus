...
extend module typus::keyed_big_vector {
    ...
    fun test_kbv_do() {
        ...
        assert_result(&kbv, bcs::to_bytes(&vector[
            vector[bcs::to_bytes(&@0xA), bcs::to_bytes(&2u64)],
            vector[bcs::to_bytes(&@0xB), bcs::to_bytes(&3u64)],
            vector[bcs::to_bytes(&@0xC), bcs::to_bytes(&4u64)],
            vector[bcs::to_bytes(&@0xD), bcs::to_bytes(&5u64)],
            vector[bcs::to_bytes(&@0xE), bcs::to_bytes(&6u64)],
        ]));
        ...
        assert_result(&kbv, bcs::to_bytes(&vector[
            vector[bcs::to_bytes(&@0xA), bcs::to_bytes(&4u64)],
            vector[bcs::to_bytes(&@0xB), bcs::to_bytes(&4u64)],
            vector[bcs::to_bytes(&@0xC), bcs::to_bytes(&8u64)],
            vector[bcs::to_bytes(&@0xD), bcs::to_bytes(&6u64)],
            vector[bcs::to_bytes(&@0xE), bcs::to_bytes(&12u64)],
        ]));
    ...
    fun test_kbv_push_pop() {
        ...
        // [(0xA, 1), (0xB, 2)], [(0xC, 3)]
        kbv.push_back(@0xA, 1u64);
        kbv.push_back(@0xB, 2u64);
        kbv.push_back(@0xC, 3u64);
        assert_result(&kbv, bcs::to_bytes(&vector[
            vector[bcs::to_bytes(&@0xA), bcs::to_bytes(&1u64)],
            vector[bcs::to_bytes(&@0xB), bcs::to_bytes(&2u64)],
            vector[bcs::to_bytes(&@0xC), bcs::to_bytes(&3u64)],
        ]));
        ...
        // [(0xA, 1), (0xD, 4)], [(0xE, 5)]
        kbv.push_back(@0xD, 4u64);
        kbv.push_back(@0xE, 5u64);
        assert_result(&kbv, bcs::to_bytes(&vector[
            vector[bcs::to_bytes(&@0xA), bcs::to_bytes(&1u64)],
            vector[bcs::to_bytes(&@0xD), bcs::to_bytes(&4u64)],
            vector[bcs::to_bytes(&@0xE), bcs::to_bytes(&5u64)],
        ]));
    ...
    fun test_kbv_borrow() {
        ...
        *v = *v * *v;
        assert_result(&kbv, bcs::to_bytes(&vector[
            vector[bcs::to_bytes(&@0xA), bcs::to_bytes(&1u64)],
            vector[bcs::to_bytes(&@0xB), bcs::to_bytes(&2u64)],
            vector[bcs::to_bytes(&@0xC), bcs::to_bytes(&9u64)],
            vector[bcs::to_bytes(&@0xD), bcs::to_bytes(&4u64)],
            vector[bcs::to_bytes(&@0xE), bcs::to_bytes(&5u64)],
        ]));
    ...
    fun test_kbv_borrow_by_key() {
        ...
        // [(0xA, 1), (0xB, 2)], [(0xC, 3), (0xD, 4)], [(0xE, 5)]
        assert!(kbv.borrow_by_key(@0xC) == 3u64, 0u64);
